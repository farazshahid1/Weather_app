...
export function fetchPosts(address) {
  ...
  return function (dispatch) {
    ...
    const url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/'+ encodeURIComponent(address) +'.json?types=place&access_token=pk.eyJ1IjoiZmFyYXpzaGFoaWQxIiwiYSI6ImNrN3lvOThpeDAwY2szZ3FxamppMTY5bXMifQ.9W-8GrvP4WnJNYRSnvSSBw'
    return fetch(url)
      .then(
...
const forecast = (latitute, longitude, callback) => {
  ...
  const url = 'https://cors-anywhere.herokuapp.com/https://api.darksky.net/forecast/195ca987ca37b2ade73084bb2b53559c/'+latitute  +',' + longitude +'?units=si'
